...
const DesktopBlunderMeter: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className={`flex h-64 max-h-full w-full flex-col gap-2 overflow-hidden rounded-md ${showContainer ? 'border-glass-border border bg-glass p-3 backdrop-blur-md md:w-auto md:min-w-[40%] md:max-w-[40%]' : ''} md:h-full`}
    >
...
const MobileBlunderMeter: React.FC<Props> = ({
  ...
  return (
    <div
      id="analysis-blunder-meter"
      className={`flex w-full flex-col gap-2 overflow-hidden ${showContainer ? 'border-glass-border border p-3' : ''}`}
    >

    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="relative z-10 w-full max-w-[420px] overflow-hidden rounded-md border border-glassBorder bg-glass p-4 backdrop-blur-md"
        >
          <div
          ...
          <div className="relative z-10 flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="rounded-md border border-glassBorder bg-glass px-3 py-2 text-sm text-white/90 placeholder-white/40 focus:border-white/35 focus:outline-none"
              />
            </div>

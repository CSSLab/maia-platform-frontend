          ...
          <div className="flex flex-col gap-3 p-4">
            {game.id ? (
              <button
                ...
                className="flex items-center justify-center rounded border border-glass-border bg-glass px-4 py-2 text-sm font-semibold text-white/90 transition-colors duration-200 hover:bg-glass-stronger"
              >
                ANALYZE GAME
              </button>
            ) : null}
            {playAgain ? (
              <button
                onClick={playAgain}
                className="flex w-full items-center justify-center rounded border border-glass-border bg-glass px-4 py-2 text-sm font-semibold tracking-wide text-white/90 transition-colors duration-200 hover:bg-glass-stronger"
              >
                PLAY AGAIN
              </button>
            ) : null}
              ...
              {isBrain ? (
                      ...
                      return (
                        <button
                          ...
                          className={`flex h-10 w-10 items-center justify-center rounded transition-colors duration-200 md:h-12 md:w-12 ${
                            isSelectable
                              ? 'border border-glass-border bg-glass-strong hover:bg-glass-stronger'
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="flex h-16 w-16 items-center justify-center">
                    {selectedPiece ? (
                      <div className="flex items-center justify-center rounded border border-glass-border bg-glass-strong p-2">
                        <img
                      ...
                      <div className="flex h-12 w-12 items-center justify-center rounded border border-dashed border-glass-border bg-glass">
            ...
            {simulateMaiaTime !== undefined && setSimulateMaiaTime && (
              <div className="bg-transparent px-4 py-3">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex overflow-hidden rounded border border-glass-border bg-glass">
                    <button
              ...
              <div className="flex flex-col gap-3">
                {offerDraw && (
                  <button
                    ...
                    className={`w-full rounded border border-glass-border px-4 py-2 text-sm font-semibold transition-colors duration-200 ${
                      playerActive
